...
chain::HttpClient::RecvMessage chain::HttpClient::http_request(HTTP_REQUEST sendtype,std::string path, std::string content)
{
	try
	{
		RecvMessage rec;
...
bool chain::HttpClient::Initialize(std::string address){
	do
	{
