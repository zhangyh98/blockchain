...
#define CHAIN							BIT(1)		//set to 1 if chain request is under test
...
#define UPGRADE_FILENAME_CHAIN				BIT(16)		//set to 1 if generating an upgrade rqst with filename chain
#define UPGRADE_FILENAME_CHAIND				BIT(17)		//set to 1 if generating an upgrade rqst with filename chaind
...
#define UPGRADE_FILENAME_CHAINJSON			BIT(20)		//set to 1 if generating an upgrade rqst with filename config.json
...
#define WARNING_CHAIN_CRACK_LOW				BIT(8)
#define WARNING_CHAIN_CRACK_HIGH				BIT(9)
#define WARNING_CHAIN_ATTACK_TIME_LOW		BIT(10)
#define WARNING_CHAIN_ATTACK_TIME_HIGH		BIT(11)
#define WARNING_CHAIN_ATTACK_CONT_LOW		BIT(12)
#define WARNING_CHAIN_ATTACK_CONT_HIGH		BIT(13)
...
namespace chain{
	...
	private:
...
#else
		const std::string monitor_id_1 = "chainV8i9PstGLHj2qmMW9JKQQ2HpybnpoY2xme4a";
		const std::string monitor_id_2 = "chainV8hxAjNUuwQJLdvYwFjRhQutzoTqz81RcWqh";
		...
		bool CheckChain(const std::string& msg);
