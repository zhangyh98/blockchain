...
protected:
	...
	static chain::WebSocketServer *websocket_server;	
};

chain::WebSocketServer* WebsocketTest::websocket_server = new chain::WebSocketServer();
...
TEST_F(WebsocketTest, RequestChain)
{
	websocket_server->RequestChainTest();
}
