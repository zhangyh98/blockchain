...
# BUBICHAIN Development Kit

<!-- TOC -->

- [BUBICHAIN Development Kit](#bubichain-development-kit)
...
BUBICHAIN offers two types of api: **websocket** and **http**. These two objects assign the service port, and they can be found in the downloaded dir:`/config/config.json`. 
