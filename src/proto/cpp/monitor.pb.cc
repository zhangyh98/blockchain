...
void protobuf_AssignDesc_monitor_2eproto() {
  ...
  ChainStatus_descriptor_ = file->message_type(5);
  static const int ChainStatus_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ChainStatus, glue_manager_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ChainStatus, peer_manager_),
  };
...
void protobuf_AddDesc_monitor_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\001 \001(\t\022\033\n\004peer\030\002 \003(\0132\r.monitor.Peer\"e\n\013Ch"
    "ainStatus\022*\n\014glue_manager\030\001 \001(\0132\024.monito"
    "r.GlueManager\022*\n\014peer_manager\030\002 \001(\0132\024.mo"
    "nitor.PeerManager\"\201\001\n\014LedgerStatus\022-\n\rle"
    "dger_header\030\001 \001(\0132\026.protocol.LedgerHeade"
    "r\022\030\n\020transaction_size\030\002 \001(\003\022\025\n\raccount_c"
    "ount\030\003 \001(\003\022\021\n\ttimestamp\030\004 \001(\003\"]\n\016SystemP"
    ...
    "l_bytes\030\001 \001(\003\022*\n\tpartition\030\002 \003(\0132\027.monit"
    "or.SystemResource\"\033\n\003CPU\022\024\n\014used_percent"
    "\030\001 \001(\001\"\245\001\n\014SystemStatus\022)\n\010property\030\001 \001("
    "\0132\027.monitor.SystemProperty\022\'\n\006memory\030\002 \001"
    "(\0132\027.monitor.SystemResource\022\031\n\003cpu\030\003 \001(\013"
    "2\014.monitor.CPU\022&\n\npartitions\030\004 \001(\0132\022.mon"
    "itor.Partition\"^\n\013AlertStatus\022\027\n\017ledger_"
    "sequence\030\001 \001(\003\022\017\n\007node_id\030\002 \001(\t\022%\n\006syste"
    "m\030\003 \001(\0132\025.monitor.SystemStatus*\265\002\n\024MONIT"
    "OR_MESSAGE_TYPE\022\030\n\024MONITOR_MSGTYPE_NONE\020"
    "\000\022\031\n\025MONITOR_MSGTYPE_HELLO\020\036\022\034\n\030MONITOR_"
    "MSGTYPE_REGISTER\020\037\022\031\n\025MONITOR_MSGTYPE_CH"
    "AIN\020 \022\032\n\026MONITOR_MSGTYPE_LEDGER\020!\022\032\n\026MON"
    "ITOR_MSGTYPE_SYSTEM\020\"\022\031\n\025MONITOR_MSGTYPE"
    "_ALERT\020#\022\032\n\026MONITOR_MSGTYPE_NOTICE\020$\022%\n!"
    "MONITOR_MSGTYPE_ACCOUNT_EXCEPTION\020%\022\031\n\025M"
    "ONITOR_MSGTYPE_ERROR\020\'b\006proto3", 1550);
...
#if !defined(_MSC_VER) || _MSC_VER >= 1900
const int ChainStatus::kGlueManagerFieldNumber;
const int ChainStatus::kPeerManagerFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900

ChainStatus::ChainStatus()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:monitor.ChainStatus)
}
...
ChainStatus::ChainStatus(const ChainStatus& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:monitor.ChainStatus)
}
...
ChainStatus::~ChainStatus() {
  // @@protoc_insertion_point(destructor:monitor.ChainStatus)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:monitor.ChainStatus)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:monitor.ChainStatus)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:monitor.ChainStatus)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:monitor.ChainStatus)
  return false;
#undef DO_
}
...
void ChainStatus::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:monitor.ChainStatus)
  // optional .monitor.GlueManager glue_manager = 1;
  ...
  // @@protoc_insertion_point(serialize_end:monitor.ChainStatus)
}

::google::protobuf::uint8* ChainStatus::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:monitor.ChainStatus)
  // optional .monitor.GlueManager glue_manager = 1;
  if (this->has_glue_manager()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:monitor.ChainStatus)
  return target;
}

int ChainStatus::ByteSize() const {
// @@protoc_insertion_point(message_byte_size_start:monitor.ChainStatus)
  int total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:monitor.ChainStatus)
  if (GOOGLE_PREDICT_FALSE(&from == this)) {
    ::google::protobuf::internal::MergeFromFail(__FILE__, __LINE__);
  }
  const ChainStatus* source = 
      ::google::protobuf::internal::DynamicCastToGenerated<const ChainStatus>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:monitor.ChainStatus)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:monitor.ChainStatus)
    MergeFrom(*source);
  }
}

void ChainStatus::MergeFrom(const ChainStatus& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:monitor.ChainStatus)
  if (GOOGLE_PREDICT_FALSE(&from == this)) {
    ::google::protobuf::internal::MergeFromFail(__FILE__, __LINE__);
  }
...
// @@protoc_insertion_point(generalized_copy_from_start:monitor.ChainStatus)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:monitor.ChainStatus)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// optional .monitor.GlueManager glue_manager = 1;
bool ChainStatus::has_glue_manager() const {
  return !_is_default_instance_ && glue_manager_ != NULL;
}
void ChainStatus::clear_glue_manager() {
  if (GetArenaNoVirtual() == NULL && glue_manager_ != NULL) delete glue_manager_;
  glue_manager_ = NULL;
}
const ::monitor::GlueManager& ChainStatus::glue_manager() const {
  // @@protoc_insertion_point(field_get:monitor.ChainStatus.glue_manager)
  return glue_manager_ != NULL ? *glue_manager_ : *default_instance_->glue_manager_;
}
::monitor::GlueManager* ChainStatus::mutable_glue_manager() {
  
  if (glue_manager_ == NULL) {
    glue_manager_ = new ::monitor::GlueManager;
  }
  // @@protoc_insertion_point(field_mutable:monitor.ChainStatus.glue_manager)
  return glue_manager_;
}
::monitor::GlueManager* ChainStatus::release_glue_manager() {
  // @@protoc_insertion_point(field_release:monitor.ChainStatus.glue_manager)
  
  ::monitor::GlueManager* temp = glue_manager_;
  glue_manager_ = NULL;
  return temp;
}
void ChainStatus::set_allocated_glue_manager(::monitor::GlueManager* glue_manager) {
  delete glue_manager_;
  ...
  // @@protoc_insertion_point(field_set_allocated:monitor.ChainStatus.glue_manager)
}

// optional .monitor.PeerManager peer_manager = 2;
bool ChainStatus::has_peer_manager() const {
  return !_is_default_instance_ && peer_manager_ != NULL;
}
void ChainStatus::clear_peer_manager() {
  if (GetArenaNoVirtual() == NULL && peer_manager_ != NULL) delete peer_manager_;
  peer_manager_ = NULL;
}
const ::monitor::PeerManager& ChainStatus::peer_manager() const {
  // @@protoc_insertion_point(field_get:monitor.ChainStatus.peer_manager)
  return peer_manager_ != NULL ? *peer_manager_ : *default_instance_->peer_manager_;
}
::monitor::PeerManager* ChainStatus::mutable_peer_manager() {
  
  if (peer_manager_ == NULL) {
    peer_manager_ = new ::monitor::PeerManager;
  }
  // @@protoc_insertion_point(field_mutable:monitor.ChainStatus.peer_manager)
  return peer_manager_;
}
::monitor::PeerManager* ChainStatus::release_peer_manager() {
  // @@protoc_insertion_point(field_release:monitor.ChainStatus.peer_manager)
  
  ::monitor::PeerManager* temp = peer_manager_;
  peer_manager_ = NULL;
  return temp;
}
void ChainStatus::set_allocated_peer_manager(::monitor::PeerManager* peer_manager) {
  delete peer_manager_;
  ...
  // @@protoc_insertion_point(field_set_allocated:monitor.ChainStatus.peer_manager)
}
