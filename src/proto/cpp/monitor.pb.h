...
class ChainStatus : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:monitor.ChainStatus) */ {
 public:
  ChainStatus();
  virtual ~ChainStatus();
  ...
  // @@protoc_insertion_point(class_scope:monitor.ChainStatus)
 private:
...
// optional .monitor.GlueManager glue_manager = 1;
inline bool ChainStatus::has_glue_manager() const {
  return !_is_default_instance_ && glue_manager_ != NULL;
}
inline void ChainStatus::clear_glue_manager() {
  if (GetArenaNoVirtual() == NULL && glue_manager_ != NULL) delete glue_manager_;
  glue_manager_ = NULL;
}
inline const ::monitor::GlueManager& ChainStatus::glue_manager() const {
...
inline ::monitor::GlueManager* ChainStatus::mutable_glue_manager() {
...
inline ::monitor::GlueManager* ChainStatus::release_glue_manager() {
...
inline void ChainStatus::set_allocated_glue_manager(::monitor::GlueManager* glue_manager) {
...
// optional .monitor.PeerManager peer_manager = 2;
inline bool ChainStatus::has_peer_manager() const {
  return !_is_default_instance_ && peer_manager_ != NULL;
}
inline void ChainStatus::clear_peer_manager() {
  if (GetArenaNoVirtual() == NULL && peer_manager_ != NULL) delete peer_manager_;
  peer_manager_ = NULL;
}
inline const ::monitor::PeerManager& ChainStatus::peer_manager() const {
...
inline ::monitor::PeerManager* ChainStatus::mutable_peer_manager() {
...
inline ::monitor::PeerManager* ChainStatus::release_peer_manager() {
...
inline void ChainStatus::set_allocated_peer_manager(::monitor::PeerManager* peer_manager) {
