...
namespace chain {
	...
	public:
		...
		const static char *CHAIN_VERSION;
	...
	class SlowTimer : public utils::Singleton<chain::SlowTimer>, public utils::Runnable {
	public:
		SlowTimer();
		~SlowTimer();
	...
	class Global : public utils::Singleton<chain::Global>, public TimerNotify {
		asio::io_service io_service_;
